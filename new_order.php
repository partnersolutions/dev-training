													...
													if($docType==0){
																	...
																	<div class='form-group' style='margin-bottom:8px;' >
													                 ...
													                 <div class='form-group' style='margin-bottom:8px;'>
										                              <p for='productprice' class='col-sm-4 col-form-control-label'>Price Incl. VAT . . . . .</p>
										                                 <div class='col-sm-4'>
										                                     <div class='input-group'>
										                                        	<input type='text' class='form-control'  value='$priceVatterm' readonly>
										                                        	<input type='hidden' class='form-control' name='priceVat' value='$priceVat' readonly>
												                                </div>							    
									                                     	</div>
								                                       	</div>
																	</div>
														...
														<div class='col-md-6'>
																	 ...
																	 <div class='form-group'>
							    										...
							    										<div class='col-sm-6'>
							      										<div class='input-group'>
								      										<input type='text' class='form-control' name='payment_terms' value='$payment_term' readonly>
																	 ...
																	 <div class='form-group'>
							    										...
							    										<div class='col-sm-6'>
							     										 <div class='input-group'>
								      										<input type='date' class='form-control'name='dueDate' value='$dueDate' readonly>
							    		...
							    		<?php
							    			if(isset($_GET['id'])){
							    				echo "<div class='input-group'>
							    						<input name='qty' id='qty' class='form-control' style='position:relative;right:-385px;width:240px;' type='number' min='1'  onkeyup='multiply()' autofocus required />
							    						</div>";
							    			}else{
							    				echo "<div class='input-group'>
							    						<input name='qty' id='qty' class='form-control'  style='position:relative;right:-385px;width:240px;' type='number' min='1'  onkeyup='multiply()' readonly  />
							    						</div>";	
							    			}/*i*/
							    		?>
				...
				<table class="table table-bordered">
									<tr>
								  		...
								  		<th class="text-right" width='110'>Net Amount</th>
		         				  		<th class="text-right" width='65'>VAT %</th>
								  		<th class="text-right" width='110'>VAT Amount</th>
								  		<th class="text-right" width='120'>Line Amount</th>
