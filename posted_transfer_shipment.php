					 ...
					 <div class="col-xs-12 col-sm-6 col-md-10">
					 	...
					 	<div class="panel panel-default" id="panel-header">
							  ...
							  <div class="panel-heading">
							  	<form action="posted_transfer_shipment.php" method="post" name="form1" class="form-inline pull-right">
					 			<div class="form-group " id="dateform"  >
							  	...
							  	<p class="text-center">Posted Transfer Shipment</p>
					                   ...
					                   //This does the same as above, only checking if we are on the last page, and then generating the "NEXT"   
					                      if($pagenum !=$last){
					                        ...
					                        $paginationCtrls .=' <a href="'.$_SERVER['PHP_SELF'].'?pn='.$next.'">Next</a> ';
					                          ...
					                          $list = '';
					                          $query="SELECT * FROM transferentry WHERE docType=1 AND transferfromcode='$locCode'  GROUP BY transorderno ASC $limit";
					                          if(isset($_POST['date1'])){
												 $date1=$_POST['date1'];
												$query ="SELECT * FROM transferentry WHERE postingDate LIKE '%$date1%' AND docType=1 AND transferfromcode='$locCode' GROUP BY transorderno ASC $limit";
										...
										while ($row = $transfer->fetch_assoc()) {
										 $dd=$row['dueDate'];
											...
											echo "<tr>
													...
													<td class='align-left'> ".$row['transferfromadd']."	</td> 
													<td class='align-left'> ".$row['transfertocode']."	</td> 
													<td class='align-left'> ".$row['extrnaldocno']."	</td> 
													
													<td><div class='btn-group' role='group' aria-label='...'>
														  <a href='transfer_ship_view.php?tcode=".$row['transorderno']."' class='btn btn-default' style='background-color:#36d7b7;'>View Order</a>
														  <a href='print_receipt_transfership.php?id=".$row['transorderno']."' class='btn btn-warning' style='background-color:#f1a9a0;'>Print DR</a>
